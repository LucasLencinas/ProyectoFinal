...
public class DataStoreTest {
    ...
    public void setUp() {
		...
		daniel = new Usuario(4,"DanielOrdoñez");
		martin = new Usuario(5,"MartinSoifer");
    ...
    public void getRampas() {
    	...
    	assertEquals(rampas.get(0).getId(),1,0);
    	assertEquals(rampas.get(1).getId(),2,0);
    	assertEquals(rampas.get(2).getId(),3,0);
    	assertEquals(rampas.get(3).getId(),4,0);
    	assertEquals(rampas.get(4).getId(),5,0);
    	assertEquals(rampas.get(5).getId(),6,0);
    	assertEquals(rampas.get(6).getId(),7,0);
    	assertEquals(rampas.get(7).getId(),8,0);
    }
    ...
    public void getRampasRojas() {
    	...
    	assertEquals(rampasRojas.get(3).getId(),7,0);
    } 
    ...
    public void getUsuarios() {
    	...
    	assertEquals(usuarios.get(0).getId(),1,0);
    	assertEquals(usuarios.get(1).getId(),2,0);
    	assertEquals(usuarios.get(2).getId(),3,0);
    	assertEquals(usuarios.get(3).getId(),4,0);
    	assertEquals(usuarios.get(4).getId(),5,0);
    }
